...
* @param {...Int8Array|Uint8Array|Uint8ClampedArray|Int16Array|Uint16Array|Int32Array|Uint32Array|Float32Array|Float64Array} array - input arrays
...
function apply() {
	...
	for ( i = 0; i < nargs; i++ ) {
		if ( !isTypedArrayLike( args[ i ] ) ) {
			if ( !opts.out || i > 0 || !isArrayLike( args[ 0 ] )  ) {
